...
describe('HungryBear', function(){
  ...
  it('should get very hugry if the food level drops below zero', function(){
    fuzzy.foodLevel = 0;
  ...
  it('should return that the bear ate blueberries and the food level should go up 5', function() {
    expect(fuzzy.eatSmall("blueberries")).toEqual("The bear ate blueberries! Food level goes up 5");
